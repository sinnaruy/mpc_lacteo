    ...
    <div class="row justify-content-center">
      <div class="col-md-4">
        ...
        <div class="card shadow-lg p-5">
          ...
          <form id="loginForm">
            <div class="mb-4">            
              <p class="small text-muted">Recuerda que el correo electrónico debe ser el mismo que el que utilizaste para registrarte</p>
              <p class="small text-muted">Te enviaremos un correo electrónico con las instrucciones para recuperar tu contraseña</p>
