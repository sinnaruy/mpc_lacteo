        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="#">Tipo de suelo</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="row justify-content-center">
      <div class="col-md-4">
        <div class="card shadow-lg p-5">
          <!-- Título -->
          <h4 class="text-center mb-4">Tipo de suelos</h4>
          ...
          <form id="loginForm">
            ...
            <div class="mb-5">
              <label for="calidad_suelo" class="form-label">Calidad del suelo</label>
              <input type="text" class="form-control" id="calidad_suelo" name="calidad_suelo" required>
            </div>
            <div class="row">
