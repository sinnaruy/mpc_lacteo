    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        ...
        <div class="card shadow-lg p-4">
          <h4 class="text-center mb-5">Actualización de datos</h4>

          <form id="formActualizar" action="../modelo/modelo.php?opcion=2" method="POST">

            <div class="row">
              <div class="col-md-6 mb-5">
                <label for="documento" class="form-label">Número de documento</label>
                <input type="text" class="form-control" id="documento" name="documento" maxlength="10" readonly
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="nombre1" name="nombre1" maxlength="20"
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="apellido1" name="apellido1" maxlength="20"
            ...
            <div class="mb-5">
              ...
              <select class="form-select" id="perfil" name="perfil">
                ...
                <option value="Ordeñador" <?php if(isset($listarUsuario) && $listarUsuario->perfil == "Ordeñador") echo "selected"; ?>>Ordeñador</option>
                <option value="Propietario" <?php if(isset($listarUsuario) && $listarUsuario->perfil == "Propietario") echo "selected"; ?>>Propietario</option>
                <option value="Administrador" <?php if(isset($listarUsuario) && $listarUsuario->perfil == "Administrador") echo "selected"; ?>>Administrador</option>
              </select>
            </div>
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="password" class="form-control" id="clave" name="clave" maxlength="8">
            </div>

            <div class="col-md-6 mb-5">
              <label for="confirmarClave" class="form-label">Confirmar contraseña</label>
              <input type="password" class="form-control" id="confirmarClave" name="confirmarClave" maxlength="8">
            </div>

            <div class="d-grid">
              <button type="submit" class="btn btn-dark" onclick="return mostrarModalActualizado(event)">Actualizar</button>
            </div>
          </form>
        </div>
      </div>
...
<script>
  function mostrarModalActualizado(event) {
    if (typeof validacionActualizar === 'function' && !validacionActualizar()) {
      return false;
    }
    event.preventDefault();
    const modal = new bootstrap.Modal(document.getElementById('modalActualizado'));
    modal.show();
    document.getElementById('modalActualizado').addEventListener('hidden.bs.modal', function() {
