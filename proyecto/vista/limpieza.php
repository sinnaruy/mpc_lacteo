    ...
    <div class="row justify-content-center">
      <div class="col-md-4">
        <div class="card shadow-lg p-5">
          <!-- Título -->
          <h4 class="text-center mb-4">Limpieza</h4>

          <!-- Formulario -->
          <form id="loginForm">
            <div class="mb-3">
              <label for="id_limpieza" class="form-label">ID de la limpieza</label>
              <input type="text" class="form-control" id="id_limpieza" name="id_limpieza" required>
            </div>
            <div class="mb-3">
              <label for="metodo" class="form-label">Método de limpieza</label>
              <input type="text" class="form-control" id="metodo" name="metodo" required>
            </div>
            <div class="mb-5">
              <label for="frecuencia" class="form-label">Frecuencia de limpieza</label>
