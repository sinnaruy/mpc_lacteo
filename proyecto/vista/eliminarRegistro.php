...
if (isset($_GET['documento'])) {
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        echo "<script>alert('Los datos de este documento están desactivados');</script>";
    }
}
?>
...
<head>
  ...
  <script src="../js/validacionEliminar.js"></script>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        ...
        <div class="card shadow-lg p-4">
          <h4 class="text-center mb-5">Inhabilitación de datos</h4>

          <form id="formEliminar" action="../modelo/modelo.php?opcion=3" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="tel" class="form-control" id="telefono" name="telefono" maxlength="10" readonly
            ...
            <div class="d-grid">
              <button type="submit" class="btn btn-dark" onclick="return mostrarModalDesactivado(event)">Desactivar</button>
            </div>
          </form>
        </div>
      </div>
...
<div class="modal fade" id="modalDesactivado" tabindex="-1" aria-labelledby="modalDesactivadoLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalDesactivadoLabel">Usuario desactivado</h5>
...
<script>
  function mostrarModalDesactivado(event) {
    if (typeof validacionEliminar === 'function' && !validacionEliminar()) {
      return false;
    }
    event.preventDefault();
    const modal = new bootstrap.Modal(document.getElementById('modalDesactivado'));
    modal.show();
    document.getElementById('modalDesactivado').addEventListener('hidden.bs.modal', function() {
